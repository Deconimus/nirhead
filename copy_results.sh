...
rsync -P -au --no-perms --rsh "sshpass -e ssh" local_admin@192.168.0.84:~/work/pascal/nirhead/models/gghead/GGHEAD-$1*/classifier/*.json /mnt/cccavefs/ccmlops/2024-11-07-MA_PascalSielski/gghead_results/$2/classifier/
rsync -P -au --no-perms --rsh "sshpass -e ssh" local_admin@192.168.0.84:~/work/pascal/nirhead/models/gghead/GGHEAD-$1*/classifier/ /mnt/cccavefs/ccmlops/2024-11-07-MA_PascalSielski/gghead_results/$2/classifier
