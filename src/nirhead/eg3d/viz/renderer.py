...
class Renderer:
    ...
    def _render_impl(self, res,
        ...
        if 'depth_resolution_default' not in G.rendering_kwargs:
            ...
            G.rendering_kwargs['depth_resolution_importance_default'] = G.rendering_kwargs[
        ...
        G.rendering_kwargs['depth_resolution_importance'] = int(
            G.rendering_kwargs['depth_resolution_importance_default'] * depth_importance_mult)
        ...
        forward_cam2world_pose = LookAtPoseSampler.sample(3.14 / 2 + conditioning_yaw, 3.14 / 2 + conditioning_pitch,
                                                          camera_pivot, radius=camera_radius)
        ...
        all_ws = G.mapping(z=all_zs, c=all_cs, attr=all_attr, truncation_psi=trunc_psi,
        ...
        synthesis_kwargs = eg3d.dnnlib.EasyDict(noise_mode=noise_mode, force_fp32=force_fp32,
                                                cache_backbone=do_backbone_caching)
